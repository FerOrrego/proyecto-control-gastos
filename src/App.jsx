...
function App() {
  ...
  //Guardar en localstorage, y ademas de que si hay alho guardado en localstorage automaticamente se va a la pagina de gastos
  useEffect(() => {
  ...
  //Actualizar o crear nuevo gasto
